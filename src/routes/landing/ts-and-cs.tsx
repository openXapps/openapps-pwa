...
export default function TsAndCs({ coolBeans, setTcOpen }: TsAndCsProps) {
  return (
    <div className="space-y-2 max-w-5xl max-h-100 sm:max-h-120 md:max-h-150">
      <h1 className="font-semibold">Terms of Use</h1>
      <Textarea className="h-80 sm:h-110 text-sm" disabled value={
        `
Welcome to the OpenApps.co.za website (the "Website").

This Website provides this Website and Services (located at MyWebsite.com) to you subject to the notices, terms, and conditions set forth in these terms (the "Terms of Use"). In addition, when you use any of our Services, you will be subject to the rules, guidelines, policies, terms, and conditions applicable to such service, and they are incorporated into this Terms of Use by this reference.

These Terms of Use are effective as of January 13, 2026.
...
You agree and understand that My Website may, at any time, and without prior notice, revoke and/or cancel your access if you fail to meet these criteria or violate any portion of these Terms of Use
Use of this Website
...
All code, text, software, scripts, graphics, files, photos, images, logos, and materials contained on this Website, or within the Services, are the sole property of My Website.

Unauthorized use of any materials contained on this Website or within the Service may violate copyright laws, trademark laws, the laws of privacy and publicity, and/or other regulations and statutes. If you believe that any of the materials infringe on any third party's rights, please contact My Website immediately at the address provided below.
...
The Website is provided "AS IS." appfigures, its suppliers, officers, directors, employees, and agents exclude and disclaim all representations and warranties, express or implied, related to this Website or in connection with the Services. You exclude My Website from all liability for damages related to or arising out of the use of this Website.

Changes to these Terms of Use
My Website retains the right to, at any time, modify or discontinue, any or all parts of the Website without notice.

This Terms of Use was created by termsusetemplate.com for MyWebsite.com
...
Governing Law
These Terms of Use and any dispute or claim arising out of, or related to them, shall be governed by and construed in accordance with the internal laws of the My Country without giving effect to any choice or conflict of law provision or rule.

Any legal suit, action or proceeding arising out of, or related to, these Terms of Use or the Website shall be instituted exclusively in the federal courts of My Country.
        `
      } />
      <Button onClick={() => {
        coolBeans(true)
        setTcOpen(false)
      }}>I've read these terms</Button>
    </div>
  )
}
